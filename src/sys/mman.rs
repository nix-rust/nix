...
libc_bitflags! {
    ...
    pub struct MapFlags: c_int {
        ...
        #[cfg(not(any(target_os = "dragonfly", target_os = "freebsd", target_os = "nto", target_os = "aix")))]
        #[cfg_attr(docsrs, doc(cfg(all())))]
        MAP_NORESERVE;
...
pub unsafe fn madvise(
    ...
    #[cfg(target_os = "nto")]
    return Errno::result(libc::posix_madvise(addr, length, advise as i32)).map(drop);
}
