...
#[doc(hidden)]
pub(crate) extern crate core as _core;
...
macro_rules! __impl_bitflags {
    (
            ...
            fn fmt(&self, f: &mut $crate::bitflags::_core::fmt::Formatter) -> $crate::bitflags::_core::fmt::Result {
                ...
                $(
                    if <Self as __BitFlags>::$Flag(self) {
                        ...
                        first = false;
                        f.write_str($crate::bitflags::_core::stringify!($Flag))?;
                    }
                )*
                ...
                if extra_bits != 0 {
                    ...
                    first = false;
                    f.write_str("0x")?;
                    $crate::bitflags::_core::fmt::LowerHex::fmt(&extra_bits, f)?;
                }
                if first {
                    f.write_str("(empty)")?;
                }
        ...
        impl $BitFlags {
            ...
            #[inline]
            pub const fn from_bits(bits: $T) -> $crate::bitflags::_core::option::Option<Self> {
                if (bits & !Self::all().bits()) == 0 {
                    $crate::bitflags::_core::option::Option::Some(Self { bits })
                } else {
        ...
        impl $crate::bitflags::_core::iter::Extend<$BitFlags> for $BitFlags {
            fn extend<T: $crate::bitflags::_core::iter::IntoIterator<Item=Self>>(&mut self, iterator: T) {
        ...
        impl $crate::bitflags::_core::iter::FromIterator<$BitFlags> for $BitFlags {
            fn from_iter<T: $crate::bitflags::_core::iter::IntoIterator<Item=Self>>(iterator: T) -> Self {
