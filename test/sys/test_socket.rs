...
mod recvfrom {
    ...
    where
        F: Fn(RawFd, &[u8], MsgFlags) -> Result<usize> + Send + 'static,
    {
    ...
    pub fn stream() {
        ...
        let _ = sendrecv(fd1, fd2, |s, m, flags| send(s, m, flags));
    }
...
fn test_scm_credentials() {
    ...
    use nix::sys::socket::{
        recvmsg, sendmsg, setsockopt, socketpair, AddressFamily, ControlMessage,
